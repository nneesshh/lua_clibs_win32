...
static int l_current_procid(lua_State *L) {
#ifdef _WIN32
...
#if LUA_VERSION_NUM < 502
	lua_pushnumber(L, (lua_Number)procid);
#else
...
static const luaL_Reg R[] =
{
	...
	{"unpack",	l_unpack},
	{"crc32",	l_crc32 },
	{"current_procid",	l_current_procid },
	{NULL,	NULL}
};

LUALIB_API int
luaopen_lpack(lua_State *L)
{
#if LUA_VERSION_NUM < 502
/*#ifdef USE_GLOBALS
